...
{
    switch (unit) {
    case Unit::BTC: return QString("RKC");
    case Unit::mBTC: return QString("mRKC");
    case Unit::uBTC: return QString::fromUtf8("µRKC (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Rikucoins");
    case Unit::mBTC: return QString("Milli-Rikucoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Rikucoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
